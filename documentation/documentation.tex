...
Finally it's very important to say that bets can be carry out in two different ways: using less money per bet but making more bets using more betting brands or using more money per bet and only a few bets. The former is the most used, because of the spread of the money, in order to make who executes bets untreceable.
